...
for (i in 1:7) {
  ...
  write.csv(tmp_list, 
            file = paste0(deseq_outDir, "RRHO/list_", i, ".csv"),
            quote = F, row.names = F)
...
# run RRHO for each list pair
  for (j in  1:7) {
    ...
    tmp_list1 = read.csv(paste0(deseq_outDir, "RRHO/list_", j, ".csv"))
    ...
    for (k in  1:7) {
      ...
      tmp_list2 = read.csv(paste0(deseq_outDir, "RRHO/list_", k, ".csv"))
